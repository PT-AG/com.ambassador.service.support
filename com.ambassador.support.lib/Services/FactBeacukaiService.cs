...
using com.ambassador.support.lib.Models;
...
namespace com.ambassador.support.lib.Services
{
    public class FactBeacukaiService : IFactBeacukaiService
    {
        ...
        public List<PEBforExpenditureViewModel> GetBEACUKAI_ADDEDs(string invoice)
        {
            ...
            string cmdText = "Select distinct a.BCNo, a.BCDate, a.ExpenditureDate, a.Country, a.BuyerName, b.Quantity, b.ItemCode, b.ItemName, a.ExpenditureNo,b.CurrencyCode,b.Price FROM BEACUKAI_ADDED a JOIN BEACUKAI_ADDED_DETAIL b on a.BCId = b.BCId WHERE a.ExpenditureNo IN ({0})";
